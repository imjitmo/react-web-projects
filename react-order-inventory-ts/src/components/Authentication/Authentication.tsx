...
const Login = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-row justify-evenly w-[600px] h-full py-6 px-10 bg-white rounded-lg gap-2">
        <div className="flex gap-4 flex-col w-full md:w-2/3">
          {/** FORMS */}
