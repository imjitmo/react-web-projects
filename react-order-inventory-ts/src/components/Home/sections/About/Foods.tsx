  ...
  return (
    <div className="w-full min-h-screen flex flex-col flex-wrap gap-10 justify-center items-center relative">
      <motion.div
        ...
        className="bg-[url('https://lgprkxqjhxzbuavhsdgr.supabase.co/storage/v1/object/public/assets/upper_left_dish.png?t=2024-06-10T00%3A02%3A19.146Z')] bg-cover bg-bottom absolute inset-0 z-[0]"
      ></motion.div>
      <motion.div
        variants={fadeIn('down', 0.3)}
        initial="hidden"
        whileInView={'show'}
        viewport={{ once: true, amount: 0.3 }}
        className="bg-[url('https://lgprkxqjhxzbuavhsdgr.supabase.co/storage/v1/object/public/assets/top_center_dish.png?t=2024-06-10T00%3A02%3A56.655Z')] bg-cover bg-bottom absolute inset-0 z-[0]"
      ></motion.div>
      <motion.div
        ...
        whileInView={'show'}
        viewport={{ once: true, amount: 0.3 }}
        className="bg-[url('https://lgprkxqjhxzbuavhsdgr.supabase.co/storage/v1/object/public/assets/upper_right_dish.png?t=2024-06-10T00%3A03%3A12.817Z')] bg-cover bg-bottom absolute inset-0 z-[0]"
      ></motion.div>
      <motion.div
      ...
      ></motion.div>
      <div className="flex flex-col w-full items-center justify-center max-w-[600px] text-center">
