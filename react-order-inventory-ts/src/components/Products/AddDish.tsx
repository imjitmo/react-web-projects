...
import { DishesModel } from '@/hooks/models/Dishes';
...
interface AddDishProps {
  handleSubmit: (value: DishesModel) => void;
  isCreating: boolean;
  addSuccess: boolean;
}

const AddDish = ({ handleSubmit, isCreating, addSuccess }: AddDishProps) => {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="flex flex-col gap-4">
        ...
        />
        <Button className="w-full bg-orange-500 hover:bg-orange-400" disabled={isCreating}>
          {isCreating ? 'Adding...' : 'Add Dish'}
        </Button>
      </form>
    </Form>
  );
